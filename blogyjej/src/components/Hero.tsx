            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center md:space-x-8">
                <div className="lg:w-1/2 flex flex-col items-center md:items-start md:text-left mb-8 md:mb-0">
                    ...
                    <div className="flex justify-center">
                        <button
                            className="btn-primary bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Voir
                            Plus...
                        </button>
                    </div>
                </div>
                <div className="lg:w-1/2">
                    <img className="object-cover rounded w-full h-96" alt="hero"
                         src="https://leclaireur.fnac.com/wp-content/uploads/2023/10/pluto-netflix.jpg"/>
                </div>
            </div>
        </section>
    );
